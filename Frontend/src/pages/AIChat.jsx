...
const AIChat = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await fetch('http://localhost/Ecareer%20Guidance/career-guidance/api/ask-ai.php', {
        method: 'POST',
        headers: {
      ...
      console.log('Response from PHP:', textResponse); // Log the raw response

      try {
        const data = JSON.parse(textResponse); // Attempt to parse the JSON response
        const aiMessage = {
